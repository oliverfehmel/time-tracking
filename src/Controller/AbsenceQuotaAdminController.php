...
final class AbsenceQuotaAdminController extends AbstractController
{
    ...
    {
        return $this->handleForm(new AbsenceQuota(), $request, 'Kontingent anlegen');
    }
    ...
    {
        return $this->handleForm($quota, $request, 'Kontingent bearbeiten');
    }
    ...
    private function handleForm(AbsenceQuota $quota, Request $request, string $title): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->em->flush();
            $this->addFlash('success', 'Kontingent gespeichert.');
